                          ...
                          <div key={idx} className="flex flex-col gap-2 p-4 bg-slate-50 border border-slate-200 rounded-lg relative">
                            ...
                            <div className="grid grid-cols-12 gap-3 pr-8">
                              ...
                              <div className="col-span-2">
                                ...
                                <input type="number" placeholder="10" className="w-full border border-slate-200 rounded-md px-2 py-1.5 text-sm outline-none font-bold text-center"
                                  value={item.bags} onChange={e => updateItemRow(idx, 'bags', e.target.value)} />
                              </div>
                              <div className="col-span-2">
                                <label className="block text-[10px] font-bold text-slate-400 uppercase mb-1">Wt/Bag *</label>
                                <input type="number" placeholder="45.36" className="w-full border border-slate-200 rounded-md px-2 py-1.5 text-sm outline-none font-bold text-center"
                                  value={item.weightPerBag} onChange={e => updateItemRow(idx, 'weightPerBag', e.target.value)} />
                              </div>
                              <div className="col-span-4">
